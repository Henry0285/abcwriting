...
struct  ReflectionPermissionFlag_t923340559 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ReflectionPermissionFlag_t923340559, ___value___1)); }
