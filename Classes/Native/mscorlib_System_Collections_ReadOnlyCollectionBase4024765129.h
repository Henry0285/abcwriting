...
struct  ReadOnlyCollectionBase_t4024765129  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_list_0() { return static_cast<int32_t>(offsetof(ReadOnlyCollectionBase_t4024765129, ___list_0)); }
