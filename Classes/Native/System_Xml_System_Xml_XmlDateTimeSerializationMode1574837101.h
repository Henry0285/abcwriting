...
struct  XmlDateTimeSerializationMode_t1574837101 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(XmlDateTimeSerializationMode_t1574837101, ___value___1)); }
