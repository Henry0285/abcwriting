...
struct  XmlSchemaContentType_t2181579932 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(XmlSchemaContentType_t2181579932, ___value___1)); }
