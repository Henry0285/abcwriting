...
struct  XmlSchemaObjectEnumerator_t3533117600  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_ienum_0() { return static_cast<int32_t>(offsetof(XmlSchemaObjectEnumerator_t3533117600, ___ienum_0)); }
