...
struct  ConfigurationAllowDefinition_t1314059801 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ConfigurationAllowDefinition_t1314059801, ___value___1)); }
