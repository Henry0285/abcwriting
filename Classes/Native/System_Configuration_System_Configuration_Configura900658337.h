...
struct  ConfigurationElementCollectionType_t900658337 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ConfigurationElementCollectionType_t900658337, ___value___1)); }
