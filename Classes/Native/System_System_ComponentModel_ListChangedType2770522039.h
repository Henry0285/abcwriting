...
struct  ListChangedType_t2770522039 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ListChangedType_t2770522039, ___value___1)); }
