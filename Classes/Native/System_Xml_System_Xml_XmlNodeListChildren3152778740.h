...
struct  XmlNodeListChildren_t3152778740  : public XmlNodeList_t1452315167
{
public:
...
public:
	inline static int32_t get_offset_of_parent_0() { return static_cast<int32_t>(offsetof(XmlNodeListChildren_t3152778740, ___parent_0)); }
