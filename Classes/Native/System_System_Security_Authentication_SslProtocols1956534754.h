...
struct  SslProtocols_t1956534754 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SslProtocols_t1956534754, ___value___1)); }
