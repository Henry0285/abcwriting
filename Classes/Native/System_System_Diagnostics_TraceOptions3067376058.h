...
struct  TraceOptions_t3067376058 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(TraceOptions_t3067376058, ___value___1)); }
