...
struct  DTDAttributeOccurenceType_t2471931239 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(DTDAttributeOccurenceType_t2471931239, ___value___1)); }
