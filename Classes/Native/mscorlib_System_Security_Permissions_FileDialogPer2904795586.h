...
struct  FileDialogPermissionAccess_t2904795586 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(FileDialogPermissionAccess_t2904795586, ___value___1)); }
