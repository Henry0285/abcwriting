...
struct  EnlistmentOptions_t4129840277 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EnlistmentOptions_t4129840277, ___value___1)); }
