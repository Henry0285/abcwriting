...
struct  IsolatedStorageContainment_t1829532507 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(IsolatedStorageContainment_t1829532507, ___value___1)); }
