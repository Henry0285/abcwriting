...
struct  UIPermissionClipboard_t4291906996 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(UIPermissionClipboard_t4291906996, ___value___1)); }
