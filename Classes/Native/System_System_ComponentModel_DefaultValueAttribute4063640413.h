...
struct  DefaultValueAttribute_t4063640413  : public Attribute_t1145342165
{
public:
...
public:
	inline static int32_t get_offset_of_DefaultValue_0() { return static_cast<int32_t>(offsetof(DefaultValueAttribute_t4063640413, ___DefaultValue_0)); }
