...
struct  ReflectionPermission_t688653073  : public CodeAccessPermission_t738670945
{
public:
...
public:
	inline static int32_t get_offset_of_flags_0() { return static_cast<int32_t>(offsetof(ReflectionPermission_t688653073, ___flags_0)); }
