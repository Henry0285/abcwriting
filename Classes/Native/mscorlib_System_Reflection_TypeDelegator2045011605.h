...
struct  TypeDelegator_t2045011605  : public Type_t
{
public:
...
public:
	inline static int32_t get_offset_of_typeImpl_8() { return static_cast<int32_t>(offsetof(TypeDelegator_t2045011605, ___typeImpl_8)); }
