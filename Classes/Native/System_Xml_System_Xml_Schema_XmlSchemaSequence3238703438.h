...
struct  XmlSchemaSequence_t3238703438  : public XmlSchemaGroupBase_t444294441
{
public:
...
public:
	inline static int32_t get_offset_of_items_28() { return static_cast<int32_t>(offsetof(XmlSchemaSequence_t3238703438, ___items_28)); }
