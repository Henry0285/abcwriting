...
struct  SourceLevels_t1158049141 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SourceLevels_t1158049141, ___value___1)); }
