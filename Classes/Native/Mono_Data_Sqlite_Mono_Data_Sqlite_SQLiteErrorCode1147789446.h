...
struct  SQLiteErrorCode_t1147789446 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SQLiteErrorCode_t1147789446, ___value___1)); }
