...
struct  BestFitMappingAttribute_t876893457  : public Attribute_t1145342165
{
public:
...
public:
	inline static int32_t get_offset_of_bfm_0() { return static_cast<int32_t>(offsetof(BestFitMappingAttribute_t876893457, ___bfm_0)); }
