...
struct  MissingMappingAction_t3124835611 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(MissingMappingAction_t3124835611, ___value___1)); }
