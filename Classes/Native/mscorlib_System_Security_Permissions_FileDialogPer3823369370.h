...
struct  FileDialogPermission_t3823369370  : public CodeAccessPermission_t738670945
{
public:
...
public:
	inline static int32_t get_offset_of__access_0() { return static_cast<int32_t>(offsetof(FileDialogPermission_t3823369370, ____access_0)); }
