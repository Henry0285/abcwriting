...
struct  ZoneIdentityPermission_t3370618604  : public CodeAccessPermission_t738670945
{
public:
...
public:
	inline static int32_t get_offset_of_zone_0() { return static_cast<int32_t>(offsetof(ZoneIdentityPermission_t3370618604, ___zone_0)); }
