...
struct  RefEmitPermissionSet_t3912194458 
{
public:
...
public:
	inline static int32_t get_offset_of_action_0() { return static_cast<int32_t>(offsetof(RefEmitPermissionSet_t3912194458, ___action_0)); }
	...
	inline static int32_t get_offset_of_pset_1() { return static_cast<int32_t>(offsetof(RefEmitPermissionSet_t3912194458, ___pset_1)); }
...
struct RefEmitPermissionSet_t3912194458_marshaled_pinvoke
{
	int32_t ___action_0;
	char* ___pset_1;
};
// Native definition for marshalling of: System.Reflection.Emit.RefEmitPermissionSet
struct RefEmitPermissionSet_t3912194458_marshaled_com
{
	int32_t ___action_0;
	uint16_t* ___pset_1;
};
