...
struct  ListValues_t2746517  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_host_0() { return static_cast<int32_t>(offsetof(ListValues_t2746517, ___host_0)); }
