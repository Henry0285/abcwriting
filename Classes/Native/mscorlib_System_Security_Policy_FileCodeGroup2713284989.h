...
struct  FileCodeGroup_t2713284989  : public CodeGroup_t3479199835
{
public:
...
public:
	inline static int32_t get_offset_of_m_access_6() { return static_cast<int32_t>(offsetof(FileCodeGroup_t2713284989, ___m_access_6)); }
