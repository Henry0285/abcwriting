...
struct  RegistryPermissionAccess_t1083938253 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(RegistryPermissionAccess_t1083938253, ___value___1)); }
