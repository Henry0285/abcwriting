...
struct  ConfigurationUserLevel_t4079476024 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ConfigurationUserLevel_t4079476024, ___value___1)); }
