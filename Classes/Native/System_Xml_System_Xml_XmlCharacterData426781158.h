...
struct  XmlCharacterData_t426781158  : public XmlLinkedNode_t3088788382
{
public:
...
public:
	inline static int32_t get_offset_of_data_6() { return static_cast<int32_t>(offsetof(XmlCharacterData_t426781158, ___data_6)); }
