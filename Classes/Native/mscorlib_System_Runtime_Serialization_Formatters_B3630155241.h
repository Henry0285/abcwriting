...
struct  ClrTypeMetadata_t3630155241  : public TypeMetadata_t2261576450
{
public:
...
public:
	inline static int32_t get_offset_of_InstanceType_2() { return static_cast<int32_t>(offsetof(ClrTypeMetadata_t3630155241, ___InstanceType_2)); }
